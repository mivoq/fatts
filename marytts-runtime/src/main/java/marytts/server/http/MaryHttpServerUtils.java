...
public class MaryHttpServerUtils 
{
    ...
    public static Map<String, String> toKeyValuePairs(String httpString, boolean performUrlDecode)
    {
        ...
        MaryHttpServerUtils.toKeyValuePairs(httpString, performUrlDecode, keyValuePairs);
     ...
     * @param httpString the query part of the http request url
     * @param performUrlDecode whether to URL-decode the keys and values
     * @param keyValuePairs a non-null query items hashmap
     * @return
     */
    public static void toKeyValuePairs(String httpString, boolean performUrlDecode, Map<String, String> keyValuePairs)
    {
        if (httpString==null || httpString.length()==0) {
            return;
        }
    ...
    public static String getMimeType(AudioFileFormat.Type audioType)
    {
        if (audioType == AudioFileFormat.Type.WAVE) {
            ...
            return "audio/mpeg, audio/x-mpeg, audio/x-mpeg-3, audio/mpeg3, audio/x-mp3";  //"audio/x-mp3; //Does not work for Internet Explorer"
        }
