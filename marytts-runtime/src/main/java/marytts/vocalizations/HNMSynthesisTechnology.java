...
public class HNMSynthesisTechnology extends VocalizationSynthesisTechnology {
    ...
    public HNMSynthesisTechnology(String waveTimeLineFile, String unitFile, 
            String hnmFeatureFile, String intonationFeatureFile, boolean imposeF0Support) throws MaryConfigurationException {
    ...
    private AudioInputStream synthesizeUsingF0Modification(int backchannelNumber, float[] pScalesArray, float[] pScalesTimes, 
        ...
        BasicProsodyModifierParams pmodParams = new BasicProsodyModifierParams(tScalesArray, tScalesTimes, 
                pScalesArray, pScalesTimes); //Prosody from modification factors above
